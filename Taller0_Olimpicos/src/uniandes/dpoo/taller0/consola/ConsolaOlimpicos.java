...
public class ConsolaOlimpicos
{
	...
	/**
	 * Método para consultar el país de un Atleta taller 1  
	 */
	
	public void ejecutarPaisAtleta() {
		
		String nombreAtleta = input("Nombre del Atleta que desea consultar");
		String paisAtleta = calculadora.paisAtleta(nombreAtleta);
		
		if(paisAtleta==null) {
			System.out.println("\nAtleta no encontrado");
		}else {
			System.out.println("\nEl atleta " + nombreAtleta + " representa al país: " + paisAtleta);
		}
	}
